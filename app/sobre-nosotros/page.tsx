          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4 pt-4">
                <a href="https://wa.me/18297884389" className="group/icon p-3 rounded-lg glass-effect hover:glow-blue transition-all duration-300 transform hover:scale-110" title="WhatsApp">
                ...
                <a href="https://www.instagram.com/klperfumesrd?igsh=MW1sYm4zdGg1dmIxeA==" className="group/icon p-3 rounded-lg glass-effect hover:glow-teal transition-all duration-300 transform hover:scale-110" title="Instagram">
                ...
                <a href="https://www.facebook.com/share/196F6E58fH" className="group/icon p-3 rounded-lg glass-effect hover:glow-blue transition-all duration-300 transform hover:scale-110" title="Facebook">
                  <svg className="w-6 h-6 text-accent-blue group-hover/icon:text-accent-teal transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://youtube.com/@klperfumesrd?si=7QcJJCHhSP8XwQnr" className="group/icon p-3 rounded-lg glass-effect hover:glow-teal transition-all duration-300 transform hover:scale-110" title="YouTube">
                  <svg className="w-6 h-6 text-accent-teal group-hover/icon:text-accent-blue transition-colors" fill="currentColor" viewBox="0 0 24 24">
