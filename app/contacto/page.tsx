  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16 lg:px-10">
      ...
      <div className="mb-14 text-center">
        ...
        <h1 className="font-display mt-3 text-5xl text-ink">Contacto</h1>
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="col-span-full rounded-3xl bg-[#25D366]/10 p-8 text-center sm:col-span-1 lg:col-span-1">
          ...
          <p className="mt-2 text-sm text-ink-soft">Pedidos y consultas rápidas</p>
          <a
          ...
          <p className="mt-3 text-xs text-ink-soft">(809) 000-0000</p>
        </div>

        {/* Email card */}
        <div className="rounded-3xl bg-cream-dark/60 p-8 text-center">
          <div className="mx-auto mb-4 grid h-16 w-16 place-items-center rounded-2xl bg-ink">
          ...
          <p className="mt-2 text-sm text-ink-soft">Consultas y cotizaciones</p>
          <a
            href="mailto:info@klperfumesrd.com"
            className="mt-5 inline-block rounded-xl border border-ink/10 bg-white px-6 py-3 text-sm font-bold text-ink transition hover:bg-ink hover:text-white"
          >
            Enviar correo
          </a>
          <p className="mt-3 text-xs text-ink-soft">info@klperfumesrd.com</p>
        </div>
        ...
        <div className="rounded-3xl bg-cream-dark/60 p-8 text-center">
          ...
          <p className="mt-5 text-xs font-semibold text-ink-soft uppercase tracking-wide">
      ...
      <div className="mt-14 rounded-3xl border border-ink/8 p-8 text-center">
        <h2 className="font-display text-2xl text-ink">¿Tienes más preguntas?</h2>
        <p className="mt-2 text-sm text-ink-soft">
          Revisa nuestra sección de preguntas frecuentes para respuestas rápidas.
        </p>
        <a
          href="/preguntas-frecuentes"
          className="mt-6 inline-block rounded-xl border border-ink/10 px-6 py-3 text-sm font-semibold text-ink transition hover:bg-ink hover:text-white"
        >
